...
def step_fn(microbatches, params, num_heads: int):
    ...
    def body_fun(i, args):
        ...
        return grad_fn(params, batch, num_heads)
...
def run_step(
    ...
    input_shape = (microbatch_size, seq_size, embed_size)
    ...
    step = jit(step_fn, static_argnums=2)
    loss, params = step(microbatches, params, num_heads)
    print("Loss=", loss)
