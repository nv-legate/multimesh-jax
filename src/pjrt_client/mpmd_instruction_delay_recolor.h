...
#ifndef XLA_PJRT_MULTIMESH_MPMD_INSTRUCTION_DELAY_RECOLOR_H_
#define XLA_PJRT_MULTIMESH_MPMD_INSTRUCTION_DELAY_RECOLOR_H_
...
#endif  // XLA_PJRT_MULTIMESH_MPMD_INSTRUCTION_DELAY_RECOLOR_H_
