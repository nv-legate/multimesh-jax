...
#ifndef XLA_PJRT_MULTIMESH_MM_DEVICE_ASSIGNMENT_H_
#define XLA_PJRT_MULTIMESH_MM_DEVICE_ASSIGNMENT_H_
...
struct MultiMeshDeviceAssignmentConfig {
...
class MultiMeshDeviceAssignment {
 public:
  explicit MultiMeshDeviceAssignment(
      const MultiMeshDeviceAssignmentConfig& config, zuku::DeviceList devices)
...
absl::StatusOr<xla::DeviceAssignment> MultiMeshToXlaDeviceAssignment(
