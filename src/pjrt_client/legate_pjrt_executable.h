...
#ifndef XLA_PJRT_LEGATE_LEGATE_EXECUTABLE_H_
#define XLA_PJRT_LEGATE_LEGATE_EXECUTABLE_H_
...
class WrapperPjRtExecutable : public PjRtLoadedExecutable {
 public:
  WrapperPjRtExecutable(std::unique_ptr<PjRtLoadedExecutable> wrapped,
                        LegateClient* legate_client, ProgramShape program_shape)
...
class LegatePjRtExecutable : public PjRtLoadedExecutable {
 public:
  LegatePjRtExecutable(
  ...
  ~LegatePjRtExecutable() override = default;

  absl::string_view name() const override { return name_; }

  PjRtClient* client() const override;

  LegateClient* legate_client() const { return legate_client_; }
...
#endif  // XLA_PJRT_LEGATE_LEGATE_EXECUTABLE_H_
