 ...
 */
#ifndef XLA_PJRT_MULTIMESH_BUFFER_ACTION_H_
#define XLA_PJRT_MULTIMESH_BUFFER_ACTION_H_
...
/**
 @brief Encapsulates an action callback to a MultiMesh task that creates a
 stream executor device buffer from a host buffer
 */
...
#endif  // XLA_PJRT_MULTIMESH_BUFFER_ACTION_H_
