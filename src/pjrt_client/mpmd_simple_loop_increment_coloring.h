#ifndef XLA_PJRT_LEGATE_MPMD_SIMPLE_LOOP_INCREMENT_COLORING_H_
#define XLA_PJRT_LEGATE_MPMD_SIMPLE_LOOP_INCREMENT_COLORING_H_
...
#endif  // XLA_PJRT_LEGATE_MPMD_SIMPLE_LOOP_INCREMENT_COLORING_H_