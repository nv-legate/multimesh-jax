 ...
 */
#ifndef XLA_PJRT_MULTIMESH_CLIENT_H_
#define XLA_PJRT_MULTIMESH_CLIENT_H_
...
class MultiMeshClient : public PjRtClient {
 public:
  explicit MultiMeshClient(std::unique_ptr<PjRtClient> base_client,
                           xla::Backend* backend,
                           std::shared_ptr<ZukuExecuteContext> context);

  ~MultiMeshClient() override;
 ...
 private:
  ...
  std::string platform_name_{"multimesh"};
...
#endif  // XLA_PJRT_MULTIMESH_CLIENT_H_
